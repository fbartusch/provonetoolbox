...
public class ProvOneDeserialiser implements org.openprovenance.prov.model.ProvDeserialiser {
    ...
    public ProvOneDeserialiser() {
        this(new ObjectMapper());
    }

    public ProvOneDeserialiser(ObjectMapper mapper) {
        this.mapper = mapper;
    ...
    public ProvOneDeserialiser(ObjectMapper mapper, DateTimeOption dateTimeOption) {
        this.mapper = mapper;
    ...
    public ProvOneDeserialiser(ObjectMapper mapper, DateTimeOption dateTimeOption, TimeZone optionalTimeZone) {
        this.mapper = mapper;
        this.dateTimeOption = dateTimeOption;
